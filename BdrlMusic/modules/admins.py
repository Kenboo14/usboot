...
@ubot.on_message(filters.command("pause", PREFIXES) & filters.me)
...
@ubot.on_message(filters.command("resume", PREFIXES) & filters.me)
@require_admin("can_manage_video_chats")
async def _(client, message: Message):
    chat_id = message.chat.id
...
@ubot.on_message(filters.command(["end", "stop"], PREFIXES) & filters.me)
@require_admin("can_manage_video_chats")
async def _(client, message: Message):
    chat_id = message.chat.id
    try:
...
@ubot.on_message(filters.command(["skip", "next"], PREFIXES) & filters.me)
@require_admin("can_manage_video_chats")
async def _(client, message: Message):
    chat_id = message.chat.id
