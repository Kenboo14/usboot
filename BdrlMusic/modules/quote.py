...
from BdrlMusic.utils.utils import get_arg
...
@ubot.on_message(filters.command("q", PREFIXES) & filters.me)
@capture_err
...
@ubot.on_message(filters.me & filters.command(["q", "quotly"], PREFIXES))
