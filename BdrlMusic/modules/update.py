...
UPSTREAM_REPO = "https://github.com/IndomieGorengSatu/ubot-prem"
...
@ubot.on_message(filters.command("update") & filters.user(OWNER_ID))
async def update_bot(_, message: Message):
    ...
    if update_avail:
        ...
        execle(sys.executable, sys.executable, "bash start", environ)
        return
    await msg.edit(
...
@ubot.on_message(filters.command("restart") & filters.user(OWNER_ID))
