...
@ubot.on_message(filters.command(["whoiss", "infos"], PREFIXES) & filters.me)
...
@bot.on_callback_query(filters.regex("userlink"))
...
@bot.on_callback_query(filters.regex("description"))
...
@ubot.on_message(filters.command(["whois", "info"], PREFIXES) & filters.me)
...
@ubot.on_message(filters.command(["chatinfo", "cinfo", "ginfo"], PREFIXES) & filters.me)
